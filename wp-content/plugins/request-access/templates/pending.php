					...
					<thead>
						<tr>
							...
							*/ ?>
							...
							<th scope="col" id="github" class="manage-column column-github">
								<a href="#"><span><?php _e('Github', RequestAccess::$text_domain) ?></span><span class="sorting-indicator"></span></a>
							</th>
						...
						<?php foreach ($users as $user): ?>
							...
							<tr class="<?php echo $i++ % 2 != 0 ? 'alternate' : '' ?>">
								...
								*/ ?>
								...
								<td class="github column-github"><?php echo get_user_meta($user->ID, 'github', true) ?></td>
